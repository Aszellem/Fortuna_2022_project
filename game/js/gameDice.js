...
let contract_address = "0x523ef3d6480dA567C482C0eC5f466628C810AACf".toLowerCase();
...
async function random(){
  ...
  /*var getError = function(e){
     ...
     let tx = await contract.methods.randomEDiceGame(bet,amount)
     //console.log('venne');
     ...
     .once('transactionHash', function(hash){
       ...
       document.querySelector("#message").innerHTML='<a href="https://bscscan.com/tx/'+hash+'">'+smallHash+'</a>';
			 document.querySelector(".mamuer-beta").style="display:block";
			 rotateDice();
     })
     ...
     .once('receipt', function(receipt){
         console.log('receipt', receipt);
				 ...
				 //setResult(r);
				 diceResult = parseInt(r);
				 setTimeout(() => {
			     document.querySelector(".mamuer-beta").style="display:none";
			   },10000);
				 console.log(r);
				 if (r==value){
...
function check(){
	...
	document.querySelector("#wamount").textContent = document.querySelector("#amount").value*5.94;
}
...
function leaderboard(){
  let rArray = [];
  $.post( {
       url: "https://api.bscscan.com/api?module=logs&action=getLogs&fromBlock=19000000&toBlock=99999999&address=0x523ef3d6480dA567C482C0eC5f466628C810AACf&topic0=0x2d4a130b8e02c9339da13ca5a78187c8ae0e188612d0a0aa9fedcf500c544f19&apikey=YourApiKeyToken",
       dataType: "json",
       data: {},
