...
let contract_address = "0x917e49C779e683cBE43ce1f085E97F44Ae59f4a4".toLowerCase();
...
//	document.querySelector("#max-amount").textContent = maxAmount/1e18;
  ...
  //document.querySelector("#once").textContent = once;
...
function leaderboard(){
	let rArray = [];
	$.post( {
			 url: "https://api.bscscan.com/api?module=logs&action=getLogs&fromBlock=19000000&toBlock=99999999&address=0x917e49C779e683cBE43ce1f085E97F44Ae59f4a4&topic0=0xa2e797e41b4733516e86a04377f698b24b02a36e789115662de34478d368db03&apikey=YourApiKeyToken",
			 dataType: "json",
			 data: {},
