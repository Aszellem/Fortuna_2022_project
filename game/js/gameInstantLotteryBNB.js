...
//	document.querySelector("#max-amount").textContent = maxAmount/1e18;
	game = await contract.methods.games(3).call();

  document.querySelector("#currentWinningsAmount").textContent = game.currentWinningsAmount/1e18+' BNB';
  document.querySelector("#ticketPrice").textContent = game.roundPrice/1e18;
...
async function buy(){
  ...
  let number = document.querySelector("#number").value;
	...
	let weiValue = parseFloat(document.querySelector("#ticketPrice").textContent)*1e18;
  ...
  /*var getError = function(e){
     ...
     let tx = await contract.methods.theGameInstantLottery(3,number)
     //console.log('venne');
...
window.addEventListener('load', async () => {
  ...
  document.querySelector("#buy").addEventListener("click", buy);
	...
	//document.querySelector("#number").addEventListener("keyup", format(2));
