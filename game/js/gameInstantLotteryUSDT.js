...
let token_address = "0x55d398326f99059ff775485246999027b3197955".toLowerCase();
...
//	document.querySelector("#max-amount").textContent = maxAmount/1e18;
	game = await contract.methods.games(2).call();

  document.querySelector("#currentWinningsAmount").textContent = game.currentWinningsAmount/1e18+' USDT';
...
async function buy(){
  ...
  /*var getError = function(e){
     ...
     let tx = await contract.methods.theGameInstantLottery(2,number)
     //console.log('venne');
     ...
     .once('receipt', function(receipt){
         console.log('receipt', receipt);
				 ...
				 if (winNumber==number){
					 ...
					 document.querySelector("#result").textContent="YOU WIN "+winAmount+" USDT";
					 winEffect();
				 }else{
