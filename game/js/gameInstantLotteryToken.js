...
//	document.querySelector("#max-amount").textContent = maxAmount/1e18;
	game = await contract.methods.games(0).call();

  document.querySelector("#currentWinningsAmount").textContent = game.currentWinningsAmount/1e18+' Token';
...
async function buy(){
  ...
  /*var getError = function(e){
     ...
     let tx = await contract.methods.theGameInstantLottery(0,number)
     //console.log('venne');
     ...
     .once('receipt', function(receipt){
         console.log('receipt', receipt);
				 //let data = receipt['events'][4]['raw']['data'];
				 let winNumber = receipt['events']['gameScore']['returnValues']['combination'];
				 //let winNumber = parseInt(data.substr(130,64),16);
